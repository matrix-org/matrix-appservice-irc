...
module.exports.hooks = {
    ...
    irc: {
         ...
         * finishes.
         */
        onPrivateMessage: function(server, fromUser, toUser, action) {
            if (!toUser.isVirtual) {
         ...
         * @return {Promise} which is resolved/rejected when the request finishes.
         */
        onMessage: function(server, fromUser, toUser, action) {
            if (fromUser.isVirtual) {
                return q.reject(requests.ERR_VIRTUAL_USER);
            }

            if (toUser.isVirtual) {
                return module.exports.hooks.irc.onPrivateMessage(
         ...
         * @return {Promise} which is resolved/rejected when the request finishes.
         */
        onJoin: function(server, joiningUser, chan, kind) {
         ...
         * @return {Promise} which is resolved/rejected when the request finishes.
         */
        onPart: function(server, leavingUser, chan, kind) {
