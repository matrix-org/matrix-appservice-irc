 ...
 * finishes.
 */
module.exports.onPrivateMessage = Promise.coroutine(function*(req, server, fromUser,
                                                              toUser, action) {
...
module.exports.onPart = Promise.coroutine(function*(req, server, leavingUser, chan, kind) {
    ...
    let promises = matrixRooms.map(function(room) {
        ...
        return req.mxLib.leaveRoom(matrixUser.userId, room.roomId);
    });
    yield Promise.all(promises)
});
