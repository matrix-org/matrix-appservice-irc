...
/* Solve any inconsistencies between the currently known state of channels '+s' modes
   ...
   is updated to private. If ALL channels somehow being bridged into a room, that
   room is allowed to be public.
*/
PublicitySyncer.prototype._solveVisibility = Promise.coroutine(function*() {
    ...
    this._visibilityMap.mappings = yield this.ircBridge.getStore().getAllChannelMappings();
