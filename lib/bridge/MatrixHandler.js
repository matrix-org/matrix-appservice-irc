...
MatrixHandler.prototype._onAdminMessage = Promise.coroutine(function*(req, event, adminRoom) {
    ...
    if (cmd === "!nick") {
        ...
        yield this.ircBridge.getStore().storePass(domain, userId, args[0]);
        return;




        // {"type":"matrix","id":"@lukeb:localhost:8480","data":
        //     {"client_config":{
        //         "localhost":{
        //             "nick":"lukeb[m]","username":"lukeblocal"
        //         },
        //         "ipv6_chat_freenode_net":{
        //             "nick":"lukeb[via-lukebs-irc-bridge]",
        //         "username":"lukeblocal"}
        //     },"localpart":"lukeb"},"_id":"P6l0JhBMD4v5yFZU"}
    }
