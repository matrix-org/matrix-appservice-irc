...
const MSG_PMS_DISABLED = "[Bridge] Sorry, DMs are disabled on this bridge.";
const MSG_PMS_DISABLED_FEDERATION = 
  "[Bridge] Sorry, DMs are disabled on this bridge over federation.";
