 ...
 */
IdentGenerator.prototype._generateIdentUsername = function(domain, userId) {
    var self = this;
    ...
    function loop() {
        ...
        self.dataStore.getIrcClientByUsername(domain, uname).done(function(usr) {
            if (usr && usr.getUserId() !== userId) { // occupied username!
...
IdentGenerator.prototype._checkQueue = function() {
    if (!this.processing) {
