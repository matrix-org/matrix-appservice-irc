...
var generateIdentUsername = function(domain, userId) {
    ...
    function loop() {
        ...
        globalBridge.getStore().getIrcClientByUsername(domain, uname).done(function(usr) {
...
var checkQueue = function() {
    if (!processing) {
        ...
        generateIdentUsername(
            ...
            // request.
            return globalBridge.getStore().storeIrcClient(matrixUser.getId(), ircUser);
        }, function(e) {
            log.error(
