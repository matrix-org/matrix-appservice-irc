...
function ClientPool(ircBridge, ircHandler) {
...
ClientPool.prototype.createIrcClient = function(ircUser, matrixUser, isBot) {
    var bridgedClient = new BridgedClient(
        ircUser, matrixUser, isBot, this._ircBridge, this._ircHandler
    );
