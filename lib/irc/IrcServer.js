...
/**
 * Returns whether the server is configured to wait getDeboucePartsMs before
 * parting a user that has disconnected due to a net-split.
 * @return {Boolean} this.config.debounceParts.
 */
IrcServer.prototype.shouldDebounceParts = function() {
 ...
 * @return {number}
 */
IrcServer.prototype.getDebouncePartsMs = function() {
