 ...
 * @param {MatrixUser} matrixUser : Optional. The matrix user this virtual IRC user.
...
BridgedClient.prototype.connect = function() {
    ...
    this._identGenerator.getIrcNames(this._clientConfig, this.matrixUser).then((nameInfo) => {
        self.log.info(
