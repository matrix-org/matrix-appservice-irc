...
IdentGenerator.prototype._generateIdentUsername = function(domain, userId) {
    ...
    function loop() {
        ...
        self.dataStore.getMatrixUserByUsername(domain, uname).done(function(usr) {
...
IdentGenerator.prototype._checkQueue = function() {
    if (!this.processing) {
        ...
        this._generateIdentUsername(
            ...
            // request.
            let config = IrcClientConfig.newConfig(matrixUser, ircUser);
            return this.dataStore.storeIrcClientConfig(config);
        }, (e) => {
            log.error(
