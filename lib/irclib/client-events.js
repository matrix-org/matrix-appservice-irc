...
var addCollectiveHooks = function(client, connInst, callbacks) {
    client.log.debug("addCollectiveHooks");
};

var addBotHooks = function(client, connInst, callbacks) {
...
module.exports.addHooks = function(client, connInst, callbacks) {
    ...
    if (server.isBotEnabled() && client.isBot) {
        addBotHooks(client, connInst, callbacks);
    }
    else if (!server.isBotEnabled() && !client.isBot) {
        addCollectiveHooks(client, connInst, callbacks);
    }
};
