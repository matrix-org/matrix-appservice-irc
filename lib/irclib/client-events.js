...
ProcessedDict.prototype.claim = function(domain, hash, nick) {
    ...
    this.timeoutObj = setTimeout(function() {
        ...
        Object.keys(self.processed).forEach(function(domain) {
            ...
            Object.keys(entries).forEach(function(hash) {
                ...
                if ((entry.ts + CLEANUP_TIME_MS) < now) {
...
var attemptClaim = function(client, msg) {
    ...
    if (shouldClaim) {
        ...
        processed.claim(domain, hash, client.nick);
        return true;
    }
