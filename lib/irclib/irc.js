...
module.exports.setBridge = function(bridge) {
    globalBridge = bridge;
};
...
IrcLib.prototype.getBridgedClient = function(server, userId, displayName) {
    ...
    bridgedClient = pool.createIrcClient(ircUser, mxUser, false, globalBridge);
...
var loginToServer = function(server) {
    ...
    if (!bridgedClient) {
        ...
        bridgedClient = pool.createIrcClient(ircUser, null, true, globalBridge);
        log.debug(
