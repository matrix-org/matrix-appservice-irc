...
module.exports.setIrcBridge = function(ircBridge) {
    globalBridge = ircBridge;
};
...
IrcLib.prototype.getBridgedClient = function(server, userId, displayName) {
    ...
    bridgedClient = pool.createIrcClient(ircUser, mxUser, false, globalBridge.bridge);
...
var loginToServer = function(server) {
    ...
    if (!bridgedClient) {
        ...
        bridgedClient = pool.createIrcClient(ircUser, null, true, globalBridge.bridge);
        log.debug(
