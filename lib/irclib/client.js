 ...
 * @param {Object} matrixUser : The matrix user this virtual IRC user.
 * @param {boolean} isBot : True if this is the bot
 */
function VirtualIrcUser(ircUser, matrixUser, isBot) {
    ...
    this.userId = matrixUser ? matrixUser.userId : "matrixirc"; // FIXME
...
VirtualIrcUser.prototype.isDead = function() {
...
VirtualIrcUser.prototype.connect = function(callbacks) {
    ...
    names.getIrcNames(
        this.server, this.nick, this.matrixUser
...
VirtualIrcUser.prototype._keepAlive = function() {
    ...
    if (this.server.idleTimeout > 0) {
        ...
        this.log.debug(
            "_keepAlive; Restarting %ss idle timeout", this.server.idleTimeout
        );
        // restart the timeout
        var self = this;
...
VirtualIrcUser.prototype._removeChannel = function(channel) {
...
VirtualIrcUser.prototype._addChannel = function(channel) {
    var i = this.chanList.indexOf(channel);
    if (i !== -1) {
...
var joinChannel = function(self, channel) {
    ...
    if (self.server.doNotTrackChannels.indexOf(channel) !== -1) {
