...
VirtualIrcUser.prototype.sendAction = function(room, action) {
    ...
    switch (action.action) {
        case "message":
            return sendIrcMessage(this, room, "message", action.text);
        case "notice":
            return sendIrcMessage(this, room, "notice", action.text);
        case "emote":
            return sendIrcMessage(this, room, "action", action.text);
        case "topic":
            return setIrcTopic(this, room, action.topic);
        default:
...
var setIrcTopic = function(that, room, topic) {
...
var sendIrcMessage = function(that, room, msgType, text) {
    // join the room if we haven't already
    var defer = q.defer();
