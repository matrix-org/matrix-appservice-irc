 ...
 */
function IrcasClient(ircClient, domain, nick) {
...
IrcasClient.prototype.disconnect = function(msg) {
    ...
    log.info(
        "disconnect()ing %s@%s - %s", this.nick, this.domain, msg
    );
    this.dead = true;
...
IrcasClient.prototype.addListener = function(eventName, fn) {
    var self = this;
...
module.exports = {
    ...
    create: function(server, opts, onCreatedCallback) {
        ...
        var retryConnection = function(e) {
            ...
            var ircasClient = new IrcasClient(
