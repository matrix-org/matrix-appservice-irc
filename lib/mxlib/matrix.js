...
module.exports.sendNoticeRaw = function(roomId, userId, text) {
    var defer = q.defer();
    var client = sdk.getClientAs(userId);
    var content = {
         msgtype: "m.notice",
         body: text
    };
...
module.exports.createRoomWithUser = function(fromUserId, toUserId, name) {
    var defer = q.defer();
    var client = sdk.getClientAs(fromUserId);
    var room = undefined;
    client.createRoom({
        name: name,
        visibility: "private"
...
var setTopic = function(room, from, topic) {
    var defer = q.defer();
    var client = sdk.getClientAs(from.userId);
...
module.exports.joinRoom = function(roomId, matrixUser) {
    ...
    // specified.
    var client = matrixUser ? sdk.getClientAs(matrixUser.userId) : sdk.getClientAs();
