...
module.exports.createRoomWithUser = function(fromUserId, toUserId, name) {
    ...
    client.createRoom({
        ...
        room = roomModels.createMatrixRoom(response.room_id);
...
module.exports.createRoomWithAlias = function(alias, name, topic) {
    ...
    client.createRoom({
        ...
        defer.resolve(roomModels.createMatrixRoom(response.room_id));
    }, function(err) {
...
protocols.setMapper("users", PROTOCOLS.IRC, PROTOCOLS.MATRIX, function(user) {
