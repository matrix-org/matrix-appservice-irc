...
const { NedbDataStore } = require("../../lib/datastore/NedbDataStore.js");
...
describe("IPV6 Generator", function() {
    ...
    it("should generate an IPv6 address", async function() {
        ...
        const address = await generator.generate('2001:0db8:85a3::', new IrcClientConfig('@foo:example.com', 'irc.example.com'));
    ...
    it("should queue and generate multiple IPv6 addresses", async function() {
        ...
        const promises = [];
        for (let i = 0; i < 10; i++) {
            promises.push(generator.generate('2001:0db8:85a3::', new IrcClientConfig(`@foo${i}:example.com`, 'irc.example.com')));
        }
